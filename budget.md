...
- Basic Training for Website Management
...
- 3 Free Revisions
- 15 Days Free Technical Support
- Basic CMS Training
- Deployment Included
- Performance Audit
...
- Content Updates (Up to 5 Requests)
...
Major changes are treated as additional work.
...
Additional revisions beyond the included limit are billed at:

**₹800 – ₹2,000 per hour**  
or  
A fixed quotation depending on the requested work.

---

# QA & Verification (Included)

Every website undergoes a complete quality assurance process before delivery.
...
Your website is built to support future growth.
...
- Basic Documentation
- Training Session
- Warranty Period (as per package)
